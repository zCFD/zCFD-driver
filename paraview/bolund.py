...
# Read solution
bolund_0_pvtu = XMLPartitionedUnstructuredGridReader( FileName=['/work/bristol/eisbr011/GH/bolund_P16_OUTPUT/bolund_0.pvtu'] )
bolund_0_pvtu.UpdatePipeline()

# Read measurement points
output_points_txt = CSVReader( FileName=['/work/bristol/eisbr011/GH/output_points.txt'] )
...
measured_points_txt = CSVReader( FileName=['/work/bristol/eisbr011/GH/Dir_239.dat'] )
