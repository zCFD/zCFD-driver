...
wall_pvd = PVDReader(
    FileName='/scratch/co-appa1/AHMED/test_P24_OUTPUT/test_wall.pvd')
...
ahmed_pvd = PVDReader(
    FileName='/scratch/co-appa1/AHMED/ahmed_P24_OUTPUT/ahmed.pvd')
...
Clip1.ClipType.Position = [-1.3877787807814457e-17, -
                           1.3877787807814457e-17, 2.7755575615628914e-17]
Clip1.ClipType.Bounds = [-3.131999969482422, 5.21999979019165, -
                         0.9350000023841858, 0.9350000023841858, -2.374872742905154e-09, 1.399999976158142]
...
a1_cp_PVLookupTable = GetLookupTableForArray("cp", 1, RGBPoints=[-1.7252761125564575, 0.23, 0.299, 0.754, -0.7464806586503983, 0.865, 0.865, 0.865,
                                                                 0.232314795255661, 0.706, 0.016, 0.15], VectorMode='Magnitude', NanColor=[0.25, 0.0, 0.0], ColorSpace='Diverging', ScalarRangeInitialized=1.0)

a1_cp_PiecewiseFunction = CreatePiecewiseFunction(
    Points=[-1.7252761125564575, 0.0, 0.5, 0.0, 0.232314795255661, 1.0, 0.5, 0.0])
